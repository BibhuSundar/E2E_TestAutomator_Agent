...
export default function CodeReviewPage() {
  ...
  const handleReview = async () => {
    ...
    setError('')
    setResult(null)
    setApproved(false); setApprovedAt(null); setRejected(false); setRejectedAt(null); setJiraUploaded(false); setJiraUploadResult(null)
    try {
  ...
  const handleUploadToJira = async () => {
    ...
    try {
      const data = await jiraAPI.createIssue(
        key,
        `Code Review generated by Test Automator - ${new Date().toLocaleString()}`,
        result
      )
